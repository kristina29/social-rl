...
srun python3 src/socialrl.py -s nnb_limitobs1 -b 6 --pretrained_demonstrator agents/SAC_agent_Building14.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.1 --extra_policy_update --deterministic_demo
