...
srun python3 src/socialrl.py -s nnb_limitobs1_shared -b 6 --pretrained_demonstrator agents/SAC_agent_Building6.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.2 --deterministic_demo
