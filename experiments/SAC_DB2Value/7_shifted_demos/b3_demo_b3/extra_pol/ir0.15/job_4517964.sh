...
srun python3 src/socialrl.py -s nnblo1_onlyb3shifted -b 6 --pretrained_demonstrator agents/SAC_agent_Building3.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.15 --extra_policy_update
