...
srun python3 src/socialrl.py -s nnblo1_onlyb5shifted -b 6 --pretrained_demonstrator agents/SAC_agent_Building5.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.05 --extra_policy_update
