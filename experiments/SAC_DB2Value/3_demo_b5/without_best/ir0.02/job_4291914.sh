...
srun python3 src/socialrl.py -s nydata_new_buildings2 -b 6 --pretrained_demonstrator agents/SAC_agent_20230927T115120.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.02
