...
srun python3 src/socialrl.py -s nnb_limitobs1 --building_ids 1 --building_ids 2 --building_ids 4 --building_ids 6 --building_ids 9 --building_ids 14 --pretrained_demonstrator agents/SAC_agent_Building16.pkl -e 2 --tql --sac --sacdb2 --autotune --ir 0.3 --extra_policy_update --deterministic_demo
