...
if __name__ == '__main__':
    ...
    if True:
        experiment_dirs = ['30_renewable_prod/reward_05pvprice/0.5',
                           '31_randomdemo/d4/ir0.01/socialMode1',
                           '31_randomdemo/d4/ir0.01/socialMode2',
                           '31_randomdemo/d4/ir0.01/socialMode3',
                           '31_randomdemo/d4/ir0.01/socialMode4',
                           '31_randomdemo/d4/ir0.01/socialMode5',
                           '31_randomdemo/d4/ir0.01/socialMode6',
                           '31_randomdemo/d4/ir0.2/socialMode1',
                           '31_randomdemo/d4/ir0.2/socialMode2',
                           '31_randomdemo/d4/ir0.2/socialMode3',
                           '31_randomdemo/d4/ir0.2/socialMode4',
                           '31_randomdemo/d4/ir0.2/socialMode5',
                           '31_randomdemo/d4/ir0.2/socialMode6',
                           ]
