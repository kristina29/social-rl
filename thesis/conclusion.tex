...
Subsequently, we investigated DB, in which a learner tends to imitate the frequently observed actions of a demonstrator. We incorporated a social policy update into the SAC framework by modifying the entropy and value terms. Our results showed that using the demonstrator action probabilities of the learner policy was only beneficial at high IRLs. However, the results were within the performance of the SAC baseline, regardless of whether random or pre-trained demonstrators were used.
