...
\chapter{Background}
\label{Background}
\todo[inline]{Die plots optimiere ich während ihr korrekturlest (zB Schriftart, KPI blalba benenne ich um), aber könnt natürlich trotzdem gerne schreiben wenn euch was dazu auffällt :D}
...
\label{sec:marlisa}
\todo[inline]{Ggf könnte ich hier noch bisschen kürzen, den informations sharing absatz?}
