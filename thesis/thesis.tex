...
\todo[inline]{TODO ganz zum schluss checken}
\begin{tabbing}
...
%\chapter*{List of Symbols\markboth{LIST OF SYMBOLS}{LIST OF SYMBOLS}}
%\todo[inline]{Drinlassen? Erweitern mit RL kram?}
%\begin{tabbing}
%\textbf{FACUM}\hspace{0.05cm}\=Schrott\kill
%\textbf{$C_b$}\>Battery capacity of building $b$ \\
%\textbf{$E_{gen}^G$}\>Generated energy in the grid \\
%\textbf{$E_{pos}$}\>Sum of positive electricity consumption from grid for all buildings \\
%\textbf{$e_b$}\>Electricity consumption of building $b$ from the grid \\
%\textbf{$\bar{e}_b$}\>Estimated median electricity consumption of building $b$ from the grid \\
%\textbf{$ec_b$}\>Electricity cost of building $b$ for electricity from the grid \\
%\textbf{$FE_{con}$}\>Consumed fossil energy \\
%\textbf{$p_{t}^{base}$}\>Electricity price in price schedule \\
%\textbf{$p_{t}$}\>Electricity price in price schedule weighted by fossil energy share \\
%\textbf{$PV_{gen}$}\>Generated solar energy of all buildings \\
%\textbf{$pv_{gen}^b$}\>Generated solar energy of building $b$ \\
%\textbf{$RE_{gen}$}\>Generated renewable energy in the grid \\
%\textbf{$\hat{RE}_{gen}$}\>Generated renewable energy in the grid scaled by median consumption \\
%\textbf{$RE_{con}^G$}\>Consumed renewable energy from the grid from all buildings \\
%\textbf{$RE_{con}^{PV}$}\>Consumed energy from all buildings PV's \\
%\textbf{$RE_{con}$}\>Total consumed renewable energy from all buildings \\
%\textbf{$RE_{pct}$}\>Share of renewable energy of total consumed energy from all buildings \\
%\textbf{$SOC_b$}\>State of the charge of the battery of building $b$ \\
%\end{tabbing}
%
%\cleardoublepage
