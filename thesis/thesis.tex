...
\end{equation}
using replay buffer data $\mathcal{D}$ and discount factor $\gamma$. The update rule given by stochastic gradient decent is denoted as $\hat{\triangledown}_{\theta}J_Q(\theta)$.
