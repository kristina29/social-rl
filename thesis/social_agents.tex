...
The SAC agents using the demonstrator transitions perform worse than the baseline agents on all KPIs. However, using transitions from Building 6 resulted in better scores compared to the use of transitions from Building 5. This is contrary to the performance of both demonstrator buildings, as described in the previous chapter. It is possible that Building 6 provides better guidance on how agents should behave since it has a higher median PCC to the training buildings than Building 5.
