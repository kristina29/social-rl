...
Wie bereits erwähnt, haben wir für die Konzeption der sozialen Agenten nur sechs der verfügbaren 17 Gebäude genutzt. Für einige unserer Methoden haben vortrainierte Demonstratoren genutzt. Diese haben wir mit den finalen Hyperparameterwerten, Reward Funktion und State Space wie in Kapitel \ref{bla} beschrieben trainiert. Wir haben zwei verschiedene Gebäude als vortrainierte Demonstratoren genutzt, eines der sechs genutzen Gebäude und ein nicht genutztes Gebäude.
Zur Auswahl der Demonstratorgebäude haben wir den Pearson Correlation Coefficient zwischen dem non-shiftable load von allen Gebäuden und dem der sechs genutzten Gebäuden berechnet. Abbildung \ref{deinemutter} visualisiert diese Korrelationen. 
