...
To select the demonstration buildings We then chose the building with the highest median correlation to the training buildings from the set of training buildings and the remaining ones: Building Five (training building) and Building Six.
\begin{figure}[htb]
\center
