...
\center
  ...
  \caption[Results of the fossil energy consumption KPI of the Social Agent II.]{Results of the fossil energy consumption KPI of the Social Agent II depending on the imitation learning rate and the demonstrators. The shaded area shows the standard deviation between the experimenters with and without additional policy update. For demonstrator B6, one experiment was conducted with sampled and one with deterministic (determ.) demonstrator actions. }
...
\todo[inline]{Legen title, e.g. 'Demonstrator (Building data)'}
