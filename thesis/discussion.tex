...
\center
     ...
     \caption[KPI results of the evaluation buildings.]{KPIs of the asozial SAC and RBC agents on the evaluation buildings compared to the training buildings. While the RBC agents perform approximately similar on both building sets, the SAC agents perform better on the evaluation data.}
  \label{fig:eval-kpis}
\end{figure}
...
\center
  ...
  \caption[Fossil energy consumption of the Social Agent II on the evaluation buildings.]{Fossil energy consumption of the Social Agent II on the evaluation buildings for different imitation learning rates and pre-trained demonstrators.}
...
\center
  ...
  \caption[Energy Consumption of the baseline SAC agent on the individual buildings.]{Energy Consumption of the baseline SAC agent compared between the training and the evaluation buildings. While the agents perform better on average on the evaluation buildings, the standard deviation is lower on the training set.}
